...
const closeDescriptionButtons = document.querySelectorAll(
  ".myWork__item__description__close-button"
);
...
openDescriptionButtons.forEach((button) => {
  ...
  button.addEventListener("click", async () => {
    ...
    item
      .querySelector(".myWork__item__more-info__group")
...
//   window.scrollY > 0 && !burger.classList.value.includes("on")
//     ? burger.classList.add("floatMenu")
//     : burger.classList.remove("floatMenu");
// });
